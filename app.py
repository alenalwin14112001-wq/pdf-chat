...
[data-testid="stFileUploader"] label { font-size: 13px !important; font-weight: 500 !important; color: #a0a0b0 !important; }
[data-testid="stFileUploader"] { background: #1a1a2e; border: 1px dashed #3a3a5c; border-radius: 10px; padding: 10px; }
[data-testid="stChatMessage"] { border-radius: 12px; padding: 4px 8px; }
[data-testid="stChatInput"] textarea { border-radius: 24px !important; border: 1px solid #2a2a3d !important; background: #1a1a2e !important; color: #e0e0e0 !important; padding: 12px 18px !important; font-size: 14px !important; }
[data-testid="stExpander"] { border: 1px solid #2a2a3d !important; border-radius: 10px !important; background: #1a1a2e !important; }
[data-testid="stButton"] button { border-radius: 8px !important; border: 1px solid #2a2a3d !important; background: #1a1a2e !important; color: #a0a0b0 !important; font-size: 13px !important; width: 100% !important; transition: all 0.2s ease !important; }
[data-testid="stButton"] button:hover { border-color: #4a90d9 !important; color: #4a90d9 !important; }
.page-tag { display: inline-block; background: #1a3a5c; color: #4a90d9; border-radius: 6px; padding: 2px 8px; font-size: 11px; font-weight: 600; margin-left: 4px; }
.chunk-header { display: flex; align-items: center; gap: 8px; margin-bottom: 4px; }
.source-card { background: #12121e; border: 1px solid #2a2a3d; border-radius: 8px; padding: 10px 14px; margin-bottom: 8px; }
.pdf-badge { background: #1a3a5c; border: 1px solid #2a4a6c; border-radius: 8px; padding: 6px 10px; font-size: 12px; color: #4a90d9; display: flex; align-items: center; gap: 6px; margin-top: 4px; }
.topbar { background: #12121e; border-bottom: 1px solid #2a2a3d; padding: 12px 0; margin-bottom: 16px; }
.topbar h2 { font-size: 22px; font-weight: 600; color: #ffffff; margin: 0; }
.topbar p { font-size: 13px; color: #a0a0b0; margin: 2px 0 0; }
.chunks-badge { background: #0d2d1a; border: 1px solid #1a5c2a; border-radius: 8px; padding: 6px 10px; font-size: 12px; color: #4aaa6a; text-align: center; margin-top: 4px; }
</style>
...
Answer:"""
    ...
    try:
        ...
        if "ResourceExhausted" in error_msg or "429" in error_msg:
            return "⚠️ API quota exceeded. Please try again after a few minutes.", retrieved_chunks, retrieved_pages
        elif "APIConnectionError" in error_msg:
            return "⚠️ Connection error. Please check your internet connection.", retrieved_chunks, retrieved_pages
        else:
